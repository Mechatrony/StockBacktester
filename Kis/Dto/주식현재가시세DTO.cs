...
public class 주식현재가시세DTO {
  ...
  public override string ToString() {
    return $"(최저가: {stck_lwpr.ToDecimal():n0}) ~ (현재가: {stck_prpr.ToDecimal():n0}) ~ (최고가: {stck_hgpr.ToDecimal():n0}), 전일 대비: {prdy_vrss}, 호가 단위: {aspr_unit}, ({stck_shrn_iscd}, {rprs_mrkt_kor_name})";
  }
}
